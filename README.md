...
**🔗 Live demo:** https://vnmoorthy.github.io/dragnet/ — runs the full graph-detection flow client-side on sample data (no backend needed).
**📊 Pitch deck:** https://vnmoorthy.github.io/dragnet/deck.html · **Repo:** https://github.com/vnmoorthy/dragnet
